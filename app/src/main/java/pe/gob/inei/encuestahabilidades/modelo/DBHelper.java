...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        sqLiteDatabase.execSQL(SQLConstantes.SQL_CREATE_TABLA_CONTROL2);
        sqLiteDatabase.execSQL(SQLConstantes.SQL_CREATE_TABLA_CONTROL3);
        sqLiteDatabase.execSQL(SQLConstantes.SQL_CREATE_TABLA_CONTROL4);
        sqLiteDatabase.execSQL(SQLConstantes.SQL_CREATE_TABLA_CONTROL5);
        sqLiteDatabase.execSQL(SQLConstantes.SQL_CREATE_TABLA_CONTROL6);
        sqLiteDatabase.execSQL(SQLConstantes.SQL_CREATE_TABLA_CONTROL7);
        sqLiteDatabase.execSQL(SQLConstantes.SQL_CREATE_TABLA_EVALUACION1);
        sqLiteDatabase.execSQL(SQLConstantes.SQL_CREATE_TABLA_EVALUACION2);
        sqLiteDatabase.execSQL(SQLConstantes.SQL_CREATE_TABLA_EVALUACION3);
        sqLiteDatabase.execSQL(SQLConstantes.SQL_CREATE_TABLA_EVALUACION4);
        sqLiteDatabase.execSQL(SQLConstantes.SQL_CREATE_TABLA_EVALUACION5);
        sqLiteDatabase.execSQL(SQLConstantes.SQL_CREATE_TABLA_EVALUACION6);
        sqLiteDatabase.execSQL(SQLConstantes.SQL_CREATE_TABLA_EVALUACION7);
        sqLiteDatabase.execSQL(SQLConstantes.SQL_CREATE_TABLA_EVALUACIONFINAL);
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int i, int i1) {
        ...
        sqLiteDatabase.execSQL(SQLConstantes.SQL_CREATE_TABLA_FRAGMENTS);
//        sqLiteDatabase.execSQL(SQLConstantes.SQL_DELETE_CONTROL1);
//        sqLiteDatabase.execSQL(SQLConstantes.SQL_DELETE_CONTROL2);
//        sqLiteDatabase.execSQL(SQLConstantes.SQL_DELETE_CONTROL3);
//        sqLiteDatabase.execSQL(SQLConstantes.SQL_DELETE_CONTROL4);
//        sqLiteDatabase.execSQL(SQLConstantes.SQL_DELETE_CONTROL5);
//        sqLiteDatabase.execSQL(SQLConstantes.SQL_DELETE_CONTROL6);
//        sqLiteDatabase.execSQL(SQLConstantes.SQL_DELETE_CONTROL7);
//        sqLiteDatabase.execSQL(SQLConstantes.SQL_DELETE_EVALUACION1);
//        sqLiteDatabase.execSQL(SQLConstantes.SQL_DELETE_EVALUACION2);
//        sqLiteDatabase.execSQL(SQLConstantes.SQL_DELETE_EVALUACION3);
//        sqLiteDatabase.execSQL(SQLConstantes.SQL_DELETE_EVALUACION4);
//        sqLiteDatabase.execSQL(SQLConstantes.SQL_DELETE_EVALUACION5);
//        sqLiteDatabase.execSQL(SQLConstantes.SQL_DELETE_EVALUACION6);
//        sqLiteDatabase.execSQL(SQLConstantes.SQL_DELETE_EVALUACION7);
//        sqLiteDatabase.execSQL(SQLConstantes.SQL_DELETE_EVALUACIONFINAL);
