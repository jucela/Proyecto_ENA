 ...
 */
public class Control2Fragment2 extends Fragment {



    private Spinner c2_p2_sp1;
    private Spinner c2_p2_sp2;
    private Spinner c2_p2_sp3;
    private Spinner c2_p2_sp4;
    private Spinner c2_p2_sp5;
    private Spinner c2_p2_sp6;
    private Spinner c2_p2_sp7;
    ...
    public Control2Fragment2() {
        // Required empty public constructor
    }

    @SuppressLint("ValidFragment")
    public Control2Fragment2(String idempresa, Context context) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_control2_fragment2, container, false);
        c2_p2_sp1 = (Spinner) rootView.findViewById(R.id.c2_p2_sp1);
        c2_p2_sp2 = (Spinner) rootView.findViewById(R.id.c2_p2_sp2);
        c2_p2_sp3 = (Spinner) rootView.findViewById(R.id.c2_p2_sp3);
        c2_p2_sp4 = (Spinner) rootView.findViewById(R.id.c2_p2_sp4);
        c2_p2_sp5 = (Spinner) rootView.findViewById(R.id.c2_p2_sp5);
        c2_p2_sp6 = (Spinner) rootView.findViewById(R.id.c2_p2_sp6);
        c2_p2_sp7 = (Spinner) rootView.findViewById(R.id.c2_p2_sp7);
    ...
    public void cargarDatos(){
        ...
        //if(data.existeControl2(idempresa)){
            ...
            //pregunta 1
        if(!control2.getC2_P2_1().equals("")){
            c2_p2_sp1.setSelection(Integer.parseInt(control2.getC2_P2_1()));}
        if(!control2.getC2_P2_2().equals("")){
            c2_p2_sp2.setSelection(Integer.parseInt(control2.getC2_P2_2()));}
        if(!control2.getC2_P2_3().equals("")){
            c2_p2_sp3.setSelection(Integer.parseInt(control2.getC2_P2_3()));}
        if(!control2.getC2_P2_4().equals("")){
            c2_p2_sp4.setSelection(Integer.parseInt(control2.getC2_P2_4()));}
        if(!control2.getC2_P2_5().equals("")){
            c2_p2_sp5.setSelection(Integer.parseInt(control2.getC2_P2_5()));}
        if(!control2.getC2_P2_6().equals("")){
            c2_p2_sp6.setSelection(Integer.parseInt(control2.getC2_P2_6()));}
        if(!control2.getC2_P2_7().equals("")){
            c2_p2_sp7.setSelection(Integer.parseInt(control2.getC2_P2_7()));}
    ...
    public void llenarMapaVariables(){
        ...
        //pregunta 2
        C2_P2_1 = c2_p2_sp1.getSelectedItemPosition();
        C2_P2_2 = c2_p2_sp2.getSelectedItemPosition();
        C2_P2_3 = c2_p2_sp3.getSelectedItemPosition();
        C2_P2_4 = c2_p2_sp4.getSelectedItemPosition();
        C2_P2_5 = c2_p2_sp5.getSelectedItemPosition();
        C2_P2_6 = c2_p2_sp6.getSelectedItemPosition();
        C2_P2_7 = c2_p2_sp7.getSelectedItemPosition();
...
//        boolean vC1_P3 = false;boolean vC2_P2_0 = false;
...
//            vC1_P3=true;
//            if(C1_P3 == 6){
//                if(C2_P2_0.trim().length() >= 3) vC2_P2_0 = true;
...
//                vC1_P2_2_2 && vC1_P3 && vC2_P2_0 && vC1_P4_1_1 && vC1_P4_2_1;
