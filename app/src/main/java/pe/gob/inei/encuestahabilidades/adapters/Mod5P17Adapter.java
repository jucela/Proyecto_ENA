...
public class Mod5P17Adapter extends RecyclerView.Adapter<Mod5P17Adapter.ViewHolder>{

    ArrayList<ItemMod5P17> itemMod5P17s;
    Context context;
    ...
    public Mod5P17Adapter(ArrayList<ItemMod5P17> itemMod5P17s, Context context, OnItemClickListener mOnItemClickListener) {
        this.itemMod5P17s = itemMod5P17s;
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        final int idBD = itemMod5P17s.get(position).getId();
        holder.txTextView.setText(itemMod5P17s.get(position).getOcupacion());
        if(itemMod5P17s.get(position).getCheck() == 0){
            holder.imageView.setBackgroundResource(R.drawable.check_disabled);
        }
        if(itemMod5P17s.get(position).getCheck() == 1){
