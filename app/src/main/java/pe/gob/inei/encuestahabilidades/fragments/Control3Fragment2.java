 ...
 */
public class Control3Fragment2 extends Fragment {



    private Spinner c3_p2_sp1;
    private Spinner c3_p2_sp2;
    private Spinner c3_p2_sp3;
    private Spinner c3_p2_sp4;
    private Spinner c3_p2_sp5;
    ...
    public Control3Fragment2() {
        // Required empty public constructor
    }

    @SuppressLint("ValidFragment")
    public Control3Fragment2(String idempresa, Context context) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_control3_fragment2, container, false);
        c3_p2_sp1 = (Spinner) rootView.findViewById(R.id.c3_p2_sp1);
        c3_p2_sp2 = (Spinner) rootView.findViewById(R.id.c3_p2_sp2);
        c3_p2_sp3 = (Spinner) rootView.findViewById(R.id.c3_p2_sp3);
        c3_p2_sp4 = (Spinner) rootView.findViewById(R.id.c3_p2_sp4);
        c3_p2_sp5 = (Spinner) rootView.findViewById(R.id.c3_p2_sp5);
    ...
    public void cargarDatos(){
        ...
        //if(data.existeControl3(idempresa)){
            ...
            //pregunta 1
        if(!control3.getC3_P2_1().equals("")){
            c3_p2_sp1.setSelection(Integer.parseInt(control3.getC3_P2_1()));}
        if(!control3.getC3_P2_2().equals("")){
            c3_p2_sp2.setSelection(Integer.parseInt(control3.getC3_P2_2()));}
        if(!control3.getC3_P2_3().equals("")){
            c3_p2_sp3.setSelection(Integer.parseInt(control3.getC3_P2_3()));}
        if(!control3.getC3_P2_4().equals("")){
            c3_p2_sp4.setSelection(Integer.parseInt(control3.getC3_P2_4()));}
        if(!control3.getC3_P2_5().equals("")){
            c3_p2_sp5.setSelection(Integer.parseInt(control3.getC3_P2_5()));}
    ...
    public void llenarMapaVariables(){
        ...
        //pregunta 2
        C3_P2_1 = c3_p2_sp1.getSelectedItemPosition();
        C3_P2_2 = c3_p2_sp2.getSelectedItemPosition();
        C3_P2_3 = c3_p2_sp3.getSelectedItemPosition();
        C3_P2_4 = c3_p2_sp4.getSelectedItemPosition();
        C3_P2_5 = c3_p2_sp5.getSelectedItemPosition();
...
//        boolean vC1_P3 = false;boolean vC3_P2_0 = false;
...
//            vC1_P3=true;
//            if(C1_P3 == 6){
//                if(C3_P2_0.trim().length() >= 3) vC3_P2_0 = true;
...
//                vC1_P2_2_2 && vC1_P3 && vC3_P2_0 && vC1_P4_1_1 && vC1_P4_2_1;
