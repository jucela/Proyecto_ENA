...
public class Modulo5Fragment7 extends Fragment {
    ...
    public Modulo5Fragment7(String idempresa, Context context) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_modulo5_fragment7, container, false);
        recycler = (RecyclerView) rootView.findViewById(R.id.mod5_p11_recycler);
        return rootView;
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mod5P10P11Adapter = new Mod5P10P11Adapter(itemMod5P10P11s, getActivity().getApplicationContext(), new Mod5P10P11Adapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, final int position) {
                ...
                TextView txtP1 = (TextView) dialogView.findViewById(R.id.dialog_mod5p10p11_txtp1);
                TextView txtP2 = (TextView) dialogView.findViewById(R.id.dialog_mod5p10p11_txtp2);
                ...
                txtP1.setText("N° Tiempo Completo");
                txtP2.setText("N° Tiempo Parcial");
                                ...
                                if(!edt1.getText().toString().equals("") && !edt2.getText().toString().equals("")){
                                    ...
                                    if(suma == itemMod5P10P11s.get(position).getCantidadRequerida()){
                                        ...
                                        alertDialog.dismiss();
                                            ...
                                            "LA SUMATORIA SEGÚN LA JORNADA DE TRABAJO NO PUEDE SER DISTINTA AL TOTAL DE VACANTES DE LA OCUPACIÓN",
                                            Toast.LENGTH_SHORT).show();
                                    }
                                }else{
                                    Toast.makeText(getActivity().getApplicationContext(), "DEBE REGISTRAR NUMERO DE EMPLEOS A TIEMPO COMPLETO Y PARCIAL PARA LA OCUPACION", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
                    }
...
//        int c = 0;
//        while(correcto && c < itemMod5P10P11s.size()){
//            if(itemMod5P10P11s.get(c).getCampoNumero1().equals("")) correcto = false;
//            c++;
//        }
//        if(!correcto) Toast.makeText(context, "DEBE LLENAR TODOS LOS DATOS", Toast.LENGTH_SHORT).show();
//        return correcto;
        ...
        while(vItem && c < itemMod5P10P11s.size()){
            if(itemMod5P10P11s.get(c).getCampoNumero1().equals("")){
                vItem = false;
                if(mensaje.equals("")) mensaje = itemMod5P10P11s.get(c).getOcupacion() + ": " + "DEBE REGISTRAR NUMERO DE EMPLEOS A TIEMPO COMPLETO Y PARCIAL PARA LA OCUPACION ";
            }
            c++;
        }
...
//                vSuma = false;
//                if(mensaje.equals("")) mensaje = itemMod5P10P11s.get(c).getOcupacion()+": " + "LA SUMATORIA SEGÚN LA JORNADA DE TRABAJO NO PUEDE SER DISTINTA AL TOTAL DE VACANTES DE LA OCUPACIÓN";
//            }
//            c++;
//        }
        ...
        if(data.existeModulo5Dinamico(idempresa)){
            ...
            for(Modulo5Dinamico modulo5Dinamico : modulo5Dinamicos){
                ItemMod5P10P11 itemMod5P10P11 = new ItemMod5P10P11(
                        ...
                        modulo5Dinamico.getC5_P11_1_1(),
                        modulo5Dinamico.getC5_P11_2_1()
                );
    ...
    public void guardarDatos() {
        ...
        for (ItemMod5P10P11 itemMod5P10P11 : itemMod5P10P11s){
            ...
            contentValues.put(SQLConstantes.MODULO5_P11_1_1,itemMod5P10P11.getCampoNumero1());
            contentValues.put(SQLConstantes.MODULO5_P11_2_1,itemMod5P10P11.getCampoNumero2());
