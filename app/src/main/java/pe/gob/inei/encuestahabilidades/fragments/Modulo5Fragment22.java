 ...
 */
public class Modulo5Fragment22 extends Fragment {
    private RecyclerView recyclerView;
    private LinearLayoutManager linearLayoutManager;
    private Mod5P25P26Adapter mod5P25P26Adapter;
    private ArrayList<ItemMod5P25P26> arrayP26;
    private String idempresa;
    private ArrayList<Modulo5Dinamico> modulo5Dinamicos;
    private Context context;
    private Data data;

    public Modulo5Fragment22() {
        // Required empty public constructor
    }

    @SuppressLint("ValidFragment")
    public Modulo5Fragment22(String idempresa, Context context) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_modulo5_fragment22, container, false);
        recyclerView = (RecyclerView) rootView.findViewById(R.id.mod5_p26_recycler);
        return rootView;
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        cargarDatos();
        mod5P25P26Adapter = new Mod5P25P26Adapter(arrayP26, getActivity().getApplicationContext(),
                    ...
                    public void onItemClick(View view, final int position, int posBD) {
                        ...
                        alertDialog.setOnShowListener(new DialogInterface.OnShowListener() {
                            ...
                            public void onShow(DialogInterface dialogInterface) {
                                edt1.setText(arrayP26.get(position).getMotivo());
                                ...
                                b.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View view) {
                                        ...
                                        if(!edt1.getText().toString().equals("")){
                                            arrayP26.get(position).setMotivo(edt1.getText().toString());
                                            alertDialog.dismiss();
    ...
    private void cargarDatos() {
        arrayP26 = new ArrayList<ItemMod5P25P26>();
    ...
    public boolean validar(){
        ...
        int c = 0;
        while(correcto && c < arrayP26.size()){
            if(arrayP26.get(c).getMotivo().equals("")) correcto = false;
            c++;
        }
    ...
    public void guardarDatos() {
        data = new Data(context);
        data.open();
        for (ItemMod5P25P26 itemMod5P25P26 : arrayP26){
            ContentValues contentValues = new ContentValues(1);
            contentValues.put(SQLConstantes.MODULO5_P26,itemMod5P25P26.getMotivo());
