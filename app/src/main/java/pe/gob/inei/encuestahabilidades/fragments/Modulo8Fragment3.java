...
//    int C8_P0_0; String C8_P0_1; int C8_P0_2; String C8_P0_3;
    int C8_P1_1_3; int C8_P1_2_3;
    int C8_P2_3;
    int C8_P3_1_3; int C8_P3_2_3; int C8_P3_3_3; int C8_P3_4_3; int C8_P3_5_3; int C8_P3_6_3; String C8_P3_6_3_0;
    int C8_P4_1_3; int C8_P4_2_3; int C8_P4_3_3; int C8_P4_4_3; int C8_P4_5_3; int C8_P4_6_3; String C8_P4_6_3_0;
    int C8_P5_3;
    int C8_P6_1_3; int C8_P6_2_3; int C8_P6_3_3; int C8_P6_4_3; int C8_P6_5_3; int C8_P6_6_3;
    int C8_P7_3;
    int C8_P8_1_3; int C8_P8_2_3; int C8_P8_3_3; int C8_P8_4_3;
    int C8_P9_1_3; int C8_P9_2_3; int C8_P9_3_3; int C8_P9_4_3;
    int C8_P10_1_3; int C8_P10_2_3; int C8_P10_3_3; int C8_P10_4_3; int C8_P10_5_3; int C8_P10_6_3;
    ...
    public Modulo8Fragment3 (String idempresa, Context context) {
...
//        });
        ...
        mod8_p1_tv.setText("1. ¿Se encuentra actualmente utilizando Transporte autónomo en el proceso que utiliza para producir sus bienes o servicios?");
        mod8_p2_tv.setText("2. ¿Qué tan probable es que utilice más Transporte autónomo en los próximos  tres años en su sistema de producción de bienes y/o servicios?");
        mod8_p3_tv.setText("3. ¿Por qué no ha introducido Transporte autónomo? ");
        mod8_p4_tv.setText("4. ¿Por qué no va introducir o es poco probable que introduzca Transporte autónomo en los próximos 3 años? ");
        mod8_p5_tv.setText("5. ¿Cuál cree que va a ser el impacto neto del Transporte autónomo, en el empleo de su empresa?");
        mod8_p6_tv.setText("6. La introducción del Transporte autónomo va a llevar a:");
            ...
            public void onCheckedChanged(RadioGroup radioGroup, @IdRes int i) {
                switch (i) {
                    ...
                    case R.id.mod8_p1_rb2:
                        ...
                        mod8_p2_tv.setText("2. ¿Qué tan probable es que introduzca Transporte autónomo en los próximos  tres años en su sistema de producción de bienes y/o servicios?");
                        rgP1_a.clearCheck();
                        switch (rgP2.getCheckedRadioButtonId()) {
                            case R.id.mod8_p2_rb1:
...
//            edtEspecifiqueCargo8.setText(modulo8.getC8_P0_3());
            //pregunta 1
            if(!modulo8.getC8_P1_1_3().equals("")) {
                ((RadioButton) rgP1.getChildAt(Integer.parseInt(modulo8.getC8_P1_1_3()))).setChecked(true);
                if(modulo8.getC8_P1_1_3().equals("0")){
                    if(!modulo8.getC8_P1_2_3().equals("")){
                        ((RadioButton) rgP1_a.getChildAt(Integer.parseInt(modulo8.getC8_P1_2_3()))).setChecked(true);}
                }
            }

            //pregunta 2
            if(!modulo8.getC8_P2_3().equals(""))
                ((RadioButton)rgP2.getChildAt(Integer.parseInt(modulo8.getC8_P2_3()))).setChecked(true);

            //pregunta 3
            if(modulo8.getC8_P3_1_3().equals("1")) mod8_p3_ck1.setChecked(true);
            if(modulo8.getC8_P3_1_3().equals("0")) mod8_p3_ck1.setChecked(false);
            if(modulo8.getC8_P3_2_3().equals("1")) mod8_p3_ck2.setChecked(true);
            if(modulo8.getC8_P3_2_3().equals("0")) mod8_p3_ck2.setChecked(false);
            if(modulo8.getC8_P3_3_3().equals("1")) mod8_p3_ck3.setChecked(true);
            if(modulo8.getC8_P3_3_3().equals("0")) mod8_p3_ck3.setChecked(false);
            if(modulo8.getC8_P3_4_3().equals("1")) mod8_p3_ck4.setChecked(true);
            if(modulo8.getC8_P3_4_3().equals("0")) mod8_p3_ck4.setChecked(false);
            if(modulo8.getC8_P3_5_3().equals("1")) mod8_p3_ck5.setChecked(true);
            if(modulo8.getC8_P3_5_3().equals("0")) mod8_p3_ck5.setChecked(false);
            if(modulo8.getC8_P3_6_3().equals("1")) mod8_p3_ck6.setChecked(true);
            if(modulo8.getC8_P3_6_3().equals("0")) mod8_p3_ck6.setChecked(false);
            mod8_p3_edt.setText(modulo8.getC8_P3_6_3_0());

            //pregunta 4
            if(modulo8.getC8_P4_1_3().equals("1")) mod8_p4_ck1.setChecked(true);
            if(modulo8.getC8_P4_1_3().equals("0")) mod8_p4_ck1.setChecked(false);
            if(modulo8.getC8_P4_2_3().equals("1")) mod8_p4_ck2.setChecked(true);
            if(modulo8.getC8_P4_2_3().equals("0")) mod8_p4_ck2.setChecked(false);
            if(modulo8.getC8_P4_3_3().equals("1")) mod8_p4_ck3.setChecked(true);
            if(modulo8.getC8_P4_3_3().equals("0")) mod8_p4_ck3.setChecked(false);
            if(modulo8.getC8_P4_4_3().equals("1")) mod8_p4_ck4.setChecked(true);
            if(modulo8.getC8_P4_4_3().equals("0")) mod8_p4_ck4.setChecked(false);
            if(modulo8.getC8_P4_5_3().equals("1")) mod8_p4_ck5.setChecked(true);
            if(modulo8.getC8_P4_5_3().equals("0")) mod8_p4_ck5.setChecked(false);
            if(modulo8.getC8_P4_6_3().equals("1")) mod8_p4_ck6.setChecked(true);
            if(modulo8.getC8_P4_6_3().equals("0")) mod8_p4_ck6.setChecked(false);
            mod8_p4_edt.setText(modulo8.getC8_P4_6_3_0());

            //pregunta 5
            if(!modulo8.getC8_P5_3().equals("")){
                if(!modulo8.getC8_P5_3().equals("-1")){
                    ((RadioButton) rgP5.getChildAt(Integer.parseInt(modulo8.getC8_P5_3()))).setChecked(true);
                }
            }

            //pregunta 6
            if(modulo8.getC8_P6_1_3().equals("1")) mod8_p6_ckA.setChecked(true);
            if(modulo8.getC8_P6_1_3().equals("0")) mod8_p6_ckA.setChecked(false);
            if(modulo8.getC8_P6_2_3().equals("1")) mod8_p6_ckB.setChecked(true);
            if(modulo8.getC8_P6_2_3().equals("0")) mod8_p6_ckB.setChecked(false);
            if(modulo8.getC8_P6_3_3().equals("1")) mod8_p6_ckC.setChecked(true);
            if(modulo8.getC8_P6_3_3().equals("0")) mod8_p6_ckC.setChecked(false);
            if(modulo8.getC8_P6_4_3().equals("1")) mod8_p6_ckD.setChecked(true);
            if(modulo8.getC8_P6_4_3().equals("0")) mod8_p6_ckD.setChecked(false);
            if(modulo8.getC8_P6_5_3().equals("1")) mod8_p6_ckE.setChecked(true);
            if(modulo8.getC8_P6_5_3().equals("0")) mod8_p6_ckE.setChecked(false);
            if(modulo8.getC8_P6_6_3().equals("1")) mod8_p6_ckF.setChecked(true);
            if(modulo8.getC8_P6_6_3().equals("0")) mod8_p6_ckF.setChecked(false);

            //pregunta 7
            if(!modulo8.getC8_P7_3().equals("")){
                if(!modulo8.getC8_P7_3().equals("-1")){
                    ((RadioButton) rgP7.getChildAt(Integer.parseInt(modulo8.getC8_P7_3()))).setChecked(true);
                }
            }

            //pregunta 8
            if(modulo8.getC8_P8_1_3().equals("1")) mod8_p8_ck1.setChecked(true);
            if(modulo8.getC8_P8_1_3().equals("0")) mod8_p8_ck1.setChecked(false);
            if(modulo8.getC8_P8_2_3().equals("1")) mod8_p8_ck2.setChecked(true);
            if(modulo8.getC8_P8_2_3().equals("0")) mod8_p8_ck2.setChecked(false);
            if(modulo8.getC8_P8_3_3().equals("1")) mod8_p8_ck3.setChecked(true);
            if(modulo8.getC8_P8_3_3().equals("0")) mod8_p8_ck3.setChecked(false);
            if(modulo8.getC8_P8_4_3().equals("1")) mod8_p8_ck4.setChecked(true);
            if(modulo8.getC8_P8_4_3().equals("0")) mod8_p8_ck4.setChecked(false);

            //pregunta 9
            if(modulo8.getC8_P9_1_3().equals("1")) mod8_p9_ck1.setChecked(true);
            if(modulo8.getC8_P9_1_3().equals("0")) mod8_p9_ck1.setChecked(false);
            if(modulo8.getC8_P9_2_3().equals("1")) mod8_p9_ck2.setChecked(true);
            if(modulo8.getC8_P9_2_3().equals("0")) mod8_p9_ck2.setChecked(false);
            if(modulo8.getC8_P9_3_3().equals("1")) mod8_p9_ck3.setChecked(true);
            if(modulo8.getC8_P9_3_3().equals("0")) mod8_p9_ck3.setChecked(false);
            if(modulo8.getC8_P9_4_3().equals("1")) mod8_p9_ck4.setChecked(true);
            if(modulo8.getC8_P9_4_3().equals("0")) mod8_p9_ck4.setChecked(false);

            //pregunta 10
            if(modulo8.getC8_P10_1_3().equals("1")) mod8_p10_ck1.setChecked(true);
            if(modulo8.getC8_P10_1_3().equals("0")) mod8_p10_ck1.setChecked(false);
            if(modulo8.getC8_P10_2_3().equals("1")) mod8_p10_ck2.setChecked(true);
            if(modulo8.getC8_P10_2_3().equals("0")) mod8_p10_ck2.setChecked(false);
            if(modulo8.getC8_P10_3_3().equals("1")) mod8_p10_ck3.setChecked(true);
            if(modulo8.getC8_P10_3_3().equals("0")) mod8_p10_ck3.setChecked(false);
            if(modulo8.getC8_P10_4_3().equals("1")) mod8_p10_ck4.setChecked(true);
            if(modulo8.getC8_P10_4_3().equals("0")) mod8_p10_ck4.setChecked(false);
            if(modulo8.getC8_P10_5_3().equals("1")) mod8_p10_ck5.setChecked(true);
            if(modulo8.getC8_P10_5_3().equals("0")) mod8_p10_ck5.setChecked(false);
            if(modulo8.getC8_P10_6_3().equals("1")) mod8_p10_ck6.setChecked(true);
            if(modulo8.getC8_P10_6_3().equals("0")) mod8_p10_ck6.setChecked(false);
...
//        C8_P0_3 = edtEspecifiqueCargo8.getText().toString();
        ...
        //pregunta 3
        if(mod8_p3_ck1.isChecked())C8_P3_1_3 = 1;
        else C8_P3_1_3 = 0;
        if(mod8_p3_ck2.isChecked())C8_P3_2_3 = 1;
        else C8_P3_2_3 = 0;
        if(mod8_p3_ck3.isChecked())C8_P3_3_3 = 1;
        else C8_P3_3_3 = 0;
        if(mod8_p3_ck4.isChecked())C8_P3_4_3 = 1;
        else C8_P3_4_3 = 0;
        if(mod8_p3_ck5.isChecked())C8_P3_5_3 = 1;
        else C8_P3_5_3 = 0;
        if(mod8_p3_ck6.isChecked())C8_P3_6_3 = 1;
        else C8_P3_6_3 = 0;
        C8_P3_6_3_0 = mod8_p3_edt.getText().toString();

        //pregunta 4
        if(mod8_p4_ck1.isChecked())C8_P4_1_3 = 1;
        else C8_P4_1_3 = 0;
        if(mod8_p4_ck2.isChecked())C8_P4_2_3 = 1;
        else C8_P4_2_3 = 0;
        if(mod8_p4_ck3.isChecked())C8_P4_3_3 = 1;
        else C8_P4_3_3 = 0;
        if(mod8_p4_ck4.isChecked())C8_P4_4_3 = 1;
        else C8_P4_4_3 = 0;
        if(mod8_p4_ck5.isChecked())C8_P4_5_3 = 1;
        else C8_P4_5_3 = 0;
        if(mod8_p4_ck6.isChecked())C8_P4_6_3 = 1;
        else C8_P4_6_3 = 0;
        C8_P4_6_3_0 = mod8_p4_edt.getText().toString();
        ...
        //pregunta 6
        if(mod8_p6_ckA.isChecked())C8_P6_1_3 = 1;
        else C8_P6_1_3 = 0;
        if(mod8_p6_ckB.isChecked())C8_P6_2_3 = 1;
        else C8_P6_2_3 = 0;
        if(mod8_p6_ckC.isChecked())C8_P6_3_3 = 1;
        else C8_P6_3_3 = 0;
        if(mod8_p6_ckD.isChecked())C8_P6_4_3 = 1;
        else C8_P6_4_3 = 0;
        if(mod8_p6_ckE.isChecked())C8_P6_5_3 = 1;
        else C8_P6_5_3 = 0;
        if(mod8_p6_ckF.isChecked())C8_P6_6_3 = 1;
        else C8_P6_6_3 = 0;
        ...
        //pregunta 8
        if(mod8_p8_ck1.isChecked())C8_P8_1_3 = 1;
        else C8_P8_1_3 = 0;
        if(mod8_p8_ck2.isChecked())C8_P8_2_3 = 1;
        else C8_P8_2_3 = 0;
        if(mod8_p8_ck3.isChecked())C8_P8_3_3 = 1;
        else C8_P8_3_3 = 0;
        if(mod8_p8_ck4.isChecked())C8_P8_4_3 = 1;
        else C8_P8_4_3 = 0;

        //pregunta 9
        if(mod8_p9_ck1.isChecked())C8_P9_1_3 = 1;
        else C8_P9_1_3 = 0;
        if(mod8_p9_ck2.isChecked())C8_P9_2_3 = 1;
        else C8_P9_2_3 = 0;
        if(mod8_p9_ck3.isChecked())C8_P9_3_3 = 1;
        else C8_P9_3_3 = 0;
        if(mod8_p9_ck4.isChecked())C8_P9_4_3 = 1;
        else C8_P9_4_3 = 0;

        //pregunta 10
        if(mod8_p10_ck1.isChecked())C8_P10_1_3= 1;
        else C8_P10_1_3= 0;
        if(mod8_p10_ck2.isChecked())C8_P10_2_3= 1;
        else C8_P10_2_3= 0;
        if(mod8_p10_ck3.isChecked())C8_P10_3_3= 1;
        else C8_P10_3_3= 0;
        if(mod8_p10_ck4.isChecked())C8_P10_4_3= 1;
        else C8_P10_4_3= 0;
        if(mod8_p10_ck5.isChecked())C8_P10_5_3= 1;
        else C8_P10_5_3= 0;
        if(mod8_p10_ck6.isChecked())C8_P10_6_3= 1;
        else C8_P10_6_3= 0;
...
//            modulo8.setC8_P0_3(C8_P0_3);
            modulo8.setC8_P1_1_3(C8_P1_1_3+"");
            modulo8.setC8_P1_2_3(C8_P1_2_3+"");
            modulo8.setC8_P2_3(C8_P2_3+"");
            modulo8.setC8_P3_1_3(C8_P3_1_3+"");
            modulo8.setC8_P3_2_3(C8_P3_2_3+"");
            modulo8.setC8_P3_3_3(C8_P3_3_3+"");
            modulo8.setC8_P3_4_3(C8_P3_4_3+"");
            modulo8.setC8_P3_5_3(C8_P3_5_3+"");
            modulo8.setC8_P3_6_3(C8_P3_6_3+"");
            modulo8.setC8_P3_6_3_0(C8_P3_6_3_0);
            modulo8.setC8_P4_1_3(C8_P4_1_3+"");
            modulo8.setC8_P4_2_3(C8_P4_2_3+"");
            modulo8.setC8_P4_3_3(C8_P4_3_3+"");
            modulo8.setC8_P4_4_3(C8_P4_4_3+"");
            modulo8.setC8_P4_5_3(C8_P4_5_3+"");
            modulo8.setC8_P4_6_3(C8_P4_6_3+"");
            modulo8.setC8_P4_6_3_0(C8_P4_6_3_0);
            modulo8.setC8_P5_3(C8_P5_3+"");
            modulo8.setC8_P6_1_3(C8_P6_1_3+"");
            modulo8.setC8_P6_2_3(C8_P6_2_3+"");
            modulo8.setC8_P6_3_3(C8_P6_3_3+"");
            modulo8.setC8_P6_4_3(C8_P6_4_3+"");
            modulo8.setC8_P6_5_3(C8_P6_5_3+"");
            modulo8.setC8_P6_6_3(C8_P6_6_3+"");
            modulo8.setC8_P7_3(C8_P7_3+"");
            modulo8.setC8_P8_1_3(C8_P8_1_3+"");
            modulo8.setC8_P8_2_3(C8_P8_2_3+"");
            modulo8.setC8_P8_3_3(C8_P8_3_3+"");
            modulo8.setC8_P8_4_3(C8_P8_4_3+"");
            modulo8.setC8_P9_1_3(C8_P9_1_3+"");
            modulo8.setC8_P9_2_3(C8_P9_2_3+"");
            modulo8.setC8_P9_3_3(C8_P9_3_3+"");
            modulo8.setC8_P9_4_3(C8_P9_4_3+"");
            modulo8.setC8_P10_1_3(C8_P10_1_3+"");
            modulo8.setC8_P10_2_3(C8_P10_2_3+"");
            modulo8.setC8_P10_3_3(C8_P10_3_3+"");
            modulo8.setC8_P10_4_3(C8_P10_4_3+"");
            modulo8.setC8_P10_5_3(C8_P10_5_3+"");
            modulo8.setC8_P10_6_3(C8_P10_6_3+"");
...
//        boolean vC8_P0_1 = false; boolean vC8_P0_2 = false; boolean vC8_P0_3 = false;
        boolean vC8_P1_1_3 = false; boolean vC8_P1_2_3 = false;
        boolean vC8_P2_3 = false;
        boolean vC8_P3_1_3 = false; boolean vC8_P3_2_3 = false; boolean vC8_P3_3_3 = false; boolean vC8_P3_4_3 = false; boolean vC8_P3_5_3 = false; boolean vC8_P3_6_3 = false; boolean vC8_P3_6_3_0 = false;
        boolean vC8_P4_1_3 = false; boolean vC8_P4_2_3 = false; boolean vC8_P4_3_3 = false; boolean vC8_P4_4_3 = false; boolean vC8_P4_5_3 = false; boolean vC8_P4_6_3 = false; boolean vC8_P4_6_3_0 = false;
        boolean vC8_P5_3 = false;
        boolean vC8_P6_1_3 = false; boolean vC8_P6_2_3 = false; boolean vC8_P6_3_3 = false; boolean vC8_P6_4_3 = false; boolean vC8_P6_5_3 = false; boolean vC8_P6_6_3 = false;
        boolean vC8_P7_3 = false;
        boolean vC8_P8_1_3 = false; boolean vC8_P8_2_3 = false; boolean vC8_P8_3_3 = false; boolean vC8_P8_4_3 = false;
        boolean vC8_P9_1_3 = false; boolean vC8_P9_2_3 = false; boolean vC8_P9_3_3 = false; boolean vC8_P9_4_3 = false;
        boolean vC8_P10_1_3= false; boolean vC8_P10_2_3= false; boolean vC8_P10_3_3= false; boolean vC8_P10_4_3= false; boolean vC8_P10_5_3= false; boolean vC8_P10_6_3= false;
        ...
        if(C8_P1_1_3 == 0) {
            if (C8_P2_3 >= 0) {
                ...
                if (C8_P5_3 >= 0) {
                    //pregunta6
                    if ((C8_P6_1_3 + C8_P6_2_3 + C8_P6_3_3 + C8_P6_4_3 + C8_P6_5_3 + C8_P6_6_3) == 0) {
                        if(mensaje.equals("")) mensaje = "Pregunta 6: Marque una o más opciones";
                        valido = false;
                    }
                    if((C8_P6_1_3 + C8_P6_2_3 + C8_P6_4_3 + C8_P6_5_3) == 0 && (C8_P6_3_3+C8_P6_6_3) == 1){
                        //if(mensaje.equals("")) mensaje = "Modulo registrado correctamente";
                    }else if((C8_P6_1_3 + C8_P6_2_3 + C8_P6_5_3) >0 && (C8_P6_4_3+C8_P6_6_3) == 0){
                        //pregunta7
                        if(C8_P7_3 == -1)
                        ...
                        //pregunta8
                        if((C8_P8_1_3+C8_P8_2_3+C8_P8_3_3+C8_P8_4_3) == 0)
                        {if(mensaje.equals("")) mensaje = "Pregunta 8: Marque una o más opciones";
                            valido=false;
                        }
                    }else if((C8_P6_1_3 + C8_P6_2_3 + C8_P6_5_3) >0 && C8_P6_4_3 == 1 && C8_P6_6_3== 0){
                        //pregunta7
                        if(C8_P7_3 == -1)
                        {if(mensaje.equals("")) mensaje = "Pregunta 7: Marque una opción";
                            valido=false;
                        ...
                        //pregunta9
                        if((C8_P9_1_3+C8_P9_2_3+C8_P9_3_3+C8_P9_4_3) == 0)
                        {if(mensaje.equals("")) mensaje = "Pregunta 9: Marque una o más opciones";
                            valido=false;
                        }
                        //pregunta10
                        if((C8_P10_1_3+C8_P10_2_3+C8_P10_3_3+C8_P10_4_3+C8_P10_5_3+C8_P10_6_3) == 0)
            ...
            if(C8_P2_3 == 0 || C8_P2_3 == 1){
                //pregunta3
                if((C8_P3_1_3+C8_P3_2_3+C8_P3_3_3+C8_P3_4_3+C8_P3_5_3+C8_P3_6_3) == 0)
                {if(mensaje.equals("")) mensaje = "Pregunta 3: Marque una o más opciones";
                    valido=false;
                }
                if((C8_P3_6_3) == 1 && C8_P3_6_3_0.trim().length() == 0)
                ...
                //pregunta4
                if((C8_P4_1_3+C8_P4_2_3+C8_P4_3_3+C8_P4_4_3+C8_P4_5_3+C8_P4_6_3) == 0)
                {if(mensaje.equals("")) mensaje = "Pregunta 4: Marque una o más opciones";
                    valido=false;
                }
                if((C8_P4_6_3) == 1 && C8_P4_6_3_0.trim().length() == 0)
