...
public class Mod5P23Adapter extends RecyclerView.Adapter<Mod5P23Adapter.ViewHolder>{
    ArrayList<ItemMod5P23> itemMod5P23s;
    Context context;
    ...
    public Mod5P23Adapter(ArrayList<ItemMod5P23> itemMod5P23s, Context context, OnItemClickListener mOnItemClickListener) {
        this.itemMod5P23s = itemMod5P23s;
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        final int idBD = itemMod5P23s.get(position).getId();
        holder.txTextView.setText(itemMod5P23s.get(position).getOcupacion());
        if(itemMod5P23s.get(position).getCheck() == 0){
            holder.imageView.setBackgroundResource(R.drawable.check_disabled);
        }
        if(itemMod5P23s.get(position).getCheck() == 1){
