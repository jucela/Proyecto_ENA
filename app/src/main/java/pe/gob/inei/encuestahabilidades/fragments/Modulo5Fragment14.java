 ...
 */
public class Modulo5Fragment14 extends Fragment {
    ...
    private Data data;
    private ArrayList<ItemMod5P12P16P18> arrayP18;

    public Modulo5Fragment14() {
        // Required empty public constructor
    }

    @SuppressLint("ValidFragment")
    public Modulo5Fragment14(String idempresa, Context context) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_modulo5_fragment14, container, false);
        recyclerView = (RecyclerView) rootView.findViewById(R.id.mod5_p18_recycler);
        return rootView;
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        cargarDatos();
        mod5P12P16P18Adapter = new Mod5P12P16P18Adapter(arrayP18, getActivity().getApplicationContext(), new Mod5P12P16P18Adapter.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId, int position, int idBD) {
                ...
                arrayP18.get(position).setOpcionRg(childPos);
            }
        });
    ...
    public void cargarDatos(){
        arrayP18 = new ArrayList<ItemMod5P12P16P18>();
        ...
        if(data.existeModulo5Dinamico(idempresa)){
            ...
            for(Modulo5Dinamico modulo5Dinamico : modulo5Dinamicos){
                if(modulo5Dinamico.getC5_P12().equals("0")) {
                    int checkear = 2;
                    if(!modulo5Dinamico.getC5_P18().equals("")) checkear = Integer.parseInt(modulo5Dinamico.getC5_P18());
                    ItemMod5P12P16P18 itemMod5P12P16P18 = new ItemMod5P12P16P18(
                            modulo5Dinamico.getIDOCUPACION(),
                            modulo5Dinamico.getC5_P9_2_1(),
                            checkear,1
                    );
                    arrayP18.add(itemMod5P12P16P18);
                }
            }
        }
        data.close();
    ...
    public void guardarDatos() {
        data = new Data(context);
        data.open();
        for (ItemMod5P12P16P18 itemMod5P12P16P18 : arrayP18){
            ContentValues contentValues = new ContentValues(1);
            contentValues.put(SQLConstantes.MODULO5_P18,itemMod5P12P16P18.getOpcionRg()+"");
    ...
    public boolean validar(){
        ...
        int c = 0;
        while(correcto && c < arrayP18.size()){
            if(arrayP18.get(c).getOpcionRg() == 2) correcto = false;
            c++;
        }
