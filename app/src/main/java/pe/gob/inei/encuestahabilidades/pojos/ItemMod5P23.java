...
public class ItemMod5P23 {
    ...
    public ItemMod5P23(int id, String ocupacion, int ck1Opcion, int ck2Opcion, int ck3Opcion,
                       int ck4Opcion, int ck5Opcion, int ck6Opcion, int ck7Opcion, int ck8Opcion,
                       int ck9Opcion, String especifique, int habilitar, int check) {
        this.id = id;
